...
const cardVariants = cva('rounded-lg border transition-all duration-200', {
  variants: {
    variant: {
      ...
      perplexity:
        'bg-gray-900/50 backdrop-blur-sm text-white border-gray-800 hover:border-cyan-500/30 hover:shadow-lg hover:shadow-cyan-500/10',
      metric:
        'bg-gray-900/50 backdrop-blur-sm text-white border-gray-800 hover:border-cyan-500/30 relative overflow-hidden group',
      outline:
        'border-gray-600 bg-transparent text-gray-300 hover:bg-gray-900/30 hover:border-cyan-500/50',
    },
    size: {
      default: 'p-6',
      sm: 'p-4',
