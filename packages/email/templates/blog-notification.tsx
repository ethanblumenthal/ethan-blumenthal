            ...
            <Section className="bg-white rounded-b-lg p-8 shadow-lg">
              ...
              <Section className="border border-gray-200 rounded-lg p-6 mb-6">
                ...
                <Section className="mb-4">
                  <Text className={`inline-block px-3 py-1 rounded-full text-sm font-medium ${categoryStyle.bg} ${categoryStyle.text} m-0`}>
                    {category.replace('-', ' ').replace(/\b\w/g, l => l.toUpperCase())}
                  </Text>
                </Section>

                {/* Article Title */}
                <Heading className="text-gray-900 text-xl font-bold mt-0 mb-3">
                  {blogTitle}
                </Heading>
              ...
              <Section className="bg-blue-50 rounded-lg p-6 mb-6">
                ...
                <Text className="text-blue-700 mb-0">
                  The commercial real estate landscape is evolving rapidly with AI, 
                  blockchain, and new financial instruments. Staying informed about 
                  these trends isn't just valuable—it's essential for making smart 
              ...
              <Section className="mb-6">
                ...
                <Section>
                  <Link href={`${appUrl}/blog?category=${category}`} className="text-blue-600 hover:underline">
